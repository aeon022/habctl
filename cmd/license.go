...
var licenseCmd = &cobra.Command{
	...
	Long:  `Activate or validate your missionctl Bundle license key directly with Polar.sh. Unlocks AI habit suggestions (habctl suggest) and the AI weekly review (habctl review).`,
}
...
var licenseActivateCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		fmt.Println("✓ License activated! AI habit suggestions and weekly review unlocked.")
...
var licenseStatusCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if key == "" {
			...
			fmt.Println("Then run: habctl license activate <key>")
			return
		}
